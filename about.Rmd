...
I am planning to cover different aspects of Data science which includes Data management, Data visualization and Statistical analysis using R in subsequent courses. My primary motivation is to share maximum knowledge to whoever in need. I believe this web pages will be good enough to shape early career researchers and job seekers in the field of Data Science and health care analytics. Happy Learning.

---

## ![](R.png){width=5%} Offspring 2019 

I am very pleased to inform that the ![](R.png){width=3.5%} course become quite popular in its first stage. Nearabout 270 participants register for the course mostly from Biostatistics/ Statistics/Demography/Social Science background mostly from International Institute for Population Sciences (IIPS) and Banaras Hindu University (BHU). 

The important part of the course that it's completely free of cost and the vast data management and statistics domains have been covered by using some interactive examples. I am sharing here all the materials related to the ![](R.png){width=3.5%} course **Offspring 2019** which are as follows:
