...
I am very pleased to inform that the ![](R.png){width=2%} course become quite popular in its first stage. Nearabout 270 participants register for the course mostly from Biostatistics/ Statistics/Demography/Social Science background mostly from International Institute for Population Sciences (IIPS) and Banaras Hindu University (BHU). 

The important part of the course that it's completely free of cost and the vast data management and statistics domains have been covered by using some interactive examples. I am sharing here all the materials related to the ![](R.png){width=2%} course **Offspring 2019** which are as follows:
