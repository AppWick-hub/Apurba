...
```{r pressure, echo=FALSE, fig.cap="While attending the 5th KOSTAT Summer Training on R and Stata, 2018 in Daejeon, South Korea", out.width = '40%', fig.align="center"}
...
Predictve Modelling, Spatial Analysis, Machine Learning, Genetics of Autism, Non Communicable Diseases.
...
```{r, echo=FALSE, fig.cap="Varanasi, 2015-16", out.width = '100%', fig.align="center"}
